...
export default function Clientes() {
  ...
  let filtered = farms
  if (segment !== 'todos') {
    filtered = filtered.filter(f => f.segment === segment)
  }
  if (search.trim()) {
  ...
  return (
    <div className="content">
      ...
      {isEmpty ? (
        <div style={{
          ...
          <p style={{
            ...
            Comece cadastrando as fazendas que você atende.
            Cada fazenda fica visível apenas para você.
          </p>
          <button
      ...
      {!isEmpty && (
        <button className="fab" onClick={() => navigate('/clientes/novo')}>
          <IconUserPlus />
        </button>
      )}
    </div>
